...
nhn.CheckoutButton = (function(){
	...
	var BUTTON_TYPE_PARAM = {
		...
		"E_1_1" : {"BUTTON_CLASS" : "npay_type_E_1_1", "NPAY_BUTTON_BOX_CLASS" : "napy_vertical"							 , "NPAY_BUY_LINK_STYLE":"",                                         "NPAY_WISH_LINK_STYLE":"", "NPAY_TALK_LINK_STYLE":""},
		"E_1_2" : {"BUTTON_CLASS" : "npay_type_E_1_2", "NPAY_BUTTON_BOX_CLASS" : "napy_vertical napy_vertical2" 			 , "NPAY_BUY_LINK_STYLE":"",                                         "NPAY_WISH_LINK_STYLE":"background-position:50% -124px !important", "NPAY_TALK_LINK_STYLE":""},
		"E_2_1" : {"BUTTON_CLASS" : "npay_type_E_2_1", "NPAY_BUTTON_BOX_CLASS" : "napy_vertical"							 , "NPAY_BUY_LINK_STYLE":"background-position:50% -31px !important", "NPAY_WISH_LINK_STYLE":"",                                          "NPAY_TALK_LINK_STYLE":"background-position:50% -31px !important"},
		"E_2_2" : {"BUTTON_CLASS" : "npay_type_E_2_2", "NPAY_BUTTON_BOX_CLASS" : "napy_vertical napy_vertical2" 			 , "NPAY_BUY_LINK_STYLE":"background-position:50% -31px !important", "NPAY_WISH_LINK_STYLE":"background-position:50% -124px !important", "NPAY_TALK_LINK_STYLE":"background-position:50% -31px !important"},
		"E_3_1" : {"BUTTON_CLASS" : "npay_type_E_3_1", "NPAY_BUTTON_BOX_CLASS" : "napy_vertical npay_bg_dgray"	 			 , "NPAY_BUY_LINK_STYLE":"background-position:50% -64px !important", "NPAY_WISH_LINK_STYLE":"",                                          "NPAY_TALK_LINK_STYLE":"background-position:50% -62px !important"},
		"E_3_2" : {"BUTTON_CLASS" : "npay_type_E_3_2", "NPAY_BUTTON_BOX_CLASS" : "napy_vertical napy_vertical2 npay_bg_dgray", "NPAY_BUY_LINK_STYLE":"background-position:50% -64px !important", "NPAY_WISH_LINK_STYLE":"background-position:50% -155px !important", "NPAY_TALK_LINK_STYLE":"background-position:50% -62px !important"},
	...
	CheckoutButton.applyPromotion = function(buttonIdParam, promotionsParam, buttonParam) {
		...
		function changePromotion(index) {
			...
			if(elPromotionArea.childNodes[0]) {
				if ("title" in promotion) {
					elPromotionArea.childNodes[0].innerHTML = '['+promotion.title+']';
				} else {
					elPromotionArea.childNodes[0].innerHTML = "";
				}
			}
			...
			if(childList[0]) {
	            ...
	            if(buttonParam["BUTTON_TYPE"].indexOf('E_')>-1 && promotion.sloganContent.length>6) {
	            	newChild.innerHTML = promotion.sloganContent.substr(0,6) + '..';
				} else {
					newChild.innerHTML = promotion.sloganContent
				}
	...
	function _embedStyleSheet() {	
		document.write("<link id='"+CHECKOUT_BUTTON_STYLE_ID+"' type='text/css' rel='stylesheet' href='"+GLOBALS.LAYOUTHOST+"/static/css/button/button.css?" + Math.round(+new Date()/3600000) + "' />");
	}
